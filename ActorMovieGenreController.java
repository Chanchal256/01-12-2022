...
import com.spring.boot.demo.Repository.ActrorRepository;
import com.spring.boot.demo.Repository.GenreRepository;
import com.spring.boot.demo.Repository.MovieRepository;
import com.spring.boot.demo.model.Actor;
import com.spring.boot.demo.model.Genre;
import com.spring.boot.demo.model.Movie;

@Controller
public class ActorMovieGenreController {
	@Autowired
	private GenreRepository genreRepository;

	@Autowired
	private ActrorRepository actorRepository;
	...
	public void run() {
		...
		// ActorRepository.....
		Actor a1 = new Actor("Akshay", "kumar", 1989, null);
		Actor a2 = new Actor("Hritik", "Roshan", 1994, null);
		...
		// MovieRepository....
		Movie m1 = new Movie("Hera pheri", 2022, g1, null);
		Movie m2 = new Movie("Koi mil gya", 2019, g2, null);
